...
<body>
    ...
    <div class="escolar-contar" style="margin-right: 60%;">
        ...
        <h3 class="text-contar"><strong>Total de Escolas: <?php echo "0",$total['total']; ?></h3>
    </div>
    ...
    <div class="escolar-contar">
        ...
        <h3 class="text-contar"><strong>Total de Turmas: <?php echo "0",$totalTurmas['total']; ?></h3>
    </div>
    ...
    <div class="escolar-contar">
        ...
        <h3 class="text-contar"><strong>Total de Professores: <?php echo "0",$totalProfessores['total']; ?></h3>
    </div>
